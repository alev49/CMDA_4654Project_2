...
kNNreg = function(train, test, y_train, y_test, k, weighted) {
    ...
    return(list(Predicted_Responses = yhat, Residual_Vector= residuals, SSE = sse, Value_of_k = k))
}
...
ggplot(data = k5data)+
  geom_point(aes(x=X2, y=X1),alpha=.5, colour='red')+
  geom_point(aes(x=X2, y=X3), colour='blue', shape=5)+
